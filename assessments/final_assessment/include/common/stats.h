 ...
 * software. Misael Reyna is not liable for any misuse of this material. 
 *
 *****************************************************************************/
/**
 * @file stats.h
 * @brief Functions for providing statistics on an array of numbers, 
 *   and general practice in the "C" language
 *
 * This file contains functions that compute various statistics such as 
 * median, mean, maximum, minimum, and also sort and display an array.
 *
 * @author Misael Reyna
 * @date 2025-02-17
 *
